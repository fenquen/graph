...
impl BytesMut {
    ...
    #[inline]
    pub fn with_capacity_in(capacity: usize, allocatorExt: impl AllocatorExt) -> BytesMut {
        BytesMut::from_vec(Vec::with_capacity_in(capacity, allocatorExt))
    }
    ...
    #[inline]
    pub(crate) fn from_vec<A: AllocatorExt>(vec: Vec<u8, A>) -> BytesMut {
