...
pub fn opValueAndOpValue<'a>(op: Op, value: &'a GraphValue,
    ...
    match (op, targetOp) {
        (Op::SqlOp(SqlOp::Like), Op::SqlOp(SqlOp::Like)) => {
            ...
            // 下边的是多余的,因为like null 当 calc0的时候消化掉变为 =null
            // if value == targetValue {
            //   if let GraphValue::Null = value {
            ...
            if let (GraphValue::String(string), GraphValue::String(targetString)) = (value, targetValue) {
                ...
                match (&likePattern, &targetLikePattern) {
                    ...
                    (LikePattern::Contain(_), LikePattern::StartWith(targetString)) => {
        ...
        (_, Op::SqlOp(SqlOp::Like)) => {
            ...
            return opValueAndOpValue(targetOp, targetValue, op, value);
        }
        ...
        (Op::MathCmpOp(MathCmpOp::GreaterThan), Op::MathCmpOp(MathCmpOp::LessEqual)) => {
            ...
            // >0 and <=1 变为 (0,1]
            if targetValue > value {
                return ok_not_merged!((Op::MathCmpOp(MathCmpOp::GreaterThan), value), (Op::MathCmpOp(MathCmpOp::LessEqual), targetValue));
            }
        ...
        (Op::MathCmpOp(MathCmpOp::GreaterThan), Op::MathCmpOp(MathCmpOp::LessThan)) => {
            // >0 and <1 变为 (0,1)
            if value < targetValue {
                return ok_not_merged!((Op::MathCmpOp(MathCmpOp::GreaterThan), value), (Op::MathCmpOp(MathCmpOp::LessThan), targetValue));
            }
        ...
        (Op::MathCmpOp(MathCmpOp::GreaterEqual), Op::MathCmpOp(MathCmpOp::LessEqual)) => {
            ...
            // >=6 and <=7 变为 [6,7]
            if targetValue > value {
                return ok_not_merged!((Op::MathCmpOp(MathCmpOp::GreaterEqual), value), (Op::MathCmpOp(MathCmpOp::LessEqual), targetValue));
            }
        ...
        (Op::MathCmpOp(MathCmpOp::GreaterEqual), Op::MathCmpOp(MathCmpOp::LessThan)) => {
            // >=6 and <7 变为 [6,7)
            if targetValue < value {
                return ok_not_merged!((Op::MathCmpOp(MathCmpOp::GreaterEqual), value), (Op::MathCmpOp(MathCmpOp::LessThan), targetValue));
            }
        ...
        (Op::MathCmpOp(MathCmpOp::LessEqual), Op::MathCmpOp(MathCmpOp::GreaterThan)) => {
            // <=6 and >3 变为 (3,6]
            if value > targetValue {
                return ok_not_merged!((Op::MathCmpOp(MathCmpOp::LessEqual), value), (Op::MathCmpOp(MathCmpOp::GreaterThan), targetValue));
            }
        ...
        (Op::MathCmpOp(MathCmpOp::LessEqual), Op::MathCmpOp(MathCmpOp::GreaterEqual)) => {
            ...
            // <=1 and >0 变为 (0,1]
            if value > targetValue {
                return ok_not_merged!((Op::MathCmpOp(MathCmpOp::LessEqual), value), (Op::MathCmpOp(MathCmpOp::GreaterEqual), targetValue));
            }
        ...
        (Op::MathCmpOp(MathCmpOp::LessThan), Op::MathCmpOp(MathCmpOp::GreaterThan)) => {
            // <1 and >0 变为 (0,1)
            if value > targetValue {
                return ok_not_merged!((Op::MathCmpOp(MathCmpOp::LessThan), value), (Op::MathCmpOp(MathCmpOp::GreaterThan), targetValue));
            }
        ...
        (Op::MathCmpOp(MathCmpOp::LessThan), Op::MathCmpOp(MathCmpOp::GreaterEqual)) => {
            // <1 and >=0
            if value > targetValue {
                return ok_not_merged!((Op::MathCmpOp(MathCmpOp::LessThan), value), (Op::MathCmpOp(MathCmpOp::GreaterEqual), targetValue));
            }
